  ...
  return (
    <>
      ...
      <header className="mb-10">
        <div className="max-w-screen-md mx-auto px-5 flex justify-between items-center py-5">
      ...
      <footer className="bg-gray-300 dark:bg-gray-900 py-5 text-xs mt-10">
        <div className="max-w-screen-md mx-auto px-5">&copy; David Hayes</div>
      </footer>
    </>
  )
}
