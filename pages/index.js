...
export default function Home(props) {
  ...
  const containerClasses = 'max-w-md mx-auto'
  const cardLightClasses =
    'bg-white dark:bg-gray-900 bg-opacity-20 dark:bg-opacity-20'
  const cardDarkClasses =
    'bg-white dark:bg-gray-900 bg-opacity-30 dark:bg-opacity-30'
  ...
  return (
    <>
      ...
      <div className={`${containerClasses} text-right py-2`}>
        <button
          aria-label="Toggle Dark/Light Mode"
          type="button"
          onClick={() =>
            setTheme(theme === 'dark' || theme === undefined ? 'light' : 'dark')
          }
          className={`${cardLightClasses} p-1 rounded-full`}
        >
          {theme === 'dark' ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <header className="pt-10 px-5 mb-50 mt-80">
        <div className="rounded-md shadow-md max-w-md mx-auto">
          <div
            className={`${cardLightClasses} p-5 rounded-t-md flex flex-col items-center gap-3`}
          >
            <img
              src="/profile.jpg"
              alt="David Hayes"
            ...
            />
            <h1 className="text-2xl font-medium">David Hayes</h1>
            <p>Development lead / Front end engineer</p>
          </div>
          <div
            className={`${cardDarkClasses} p-5 rounded-b-md flex justify-center gap-5`}
          >
            <Link href="https://twitter.com/thedavehayes">
      ...
      <main className="px-5">
        <div className="rounded-md shadow-md max-w-md mx-auto">
          <div className={`${cardLightClasses} p-5 rounded-t-md`}>
            <h2 className="font-medium">About me</h2>
          </div>
          <div className={`${cardLightClasses} p-5 rounded-b-md`}>
            Hi there!
          </div>
        </div>
      </main>
      <footer className="text-center text-sm mt-20 text-gray-600 px-5">
        &copy; David Hayes
      </footer>
    </>
  )
